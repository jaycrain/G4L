      ...
      <div className="card">
        ...
        <section>
          ...
          <ul className="fg-pieces">
            ...
            <li><strong>Momentum</strong> — track the calls you make, one at a time, and see a rhythm in how they add up. Good calls, false starts, or even quiet days build into a line you can watch move.</li>
