...
// Phases (GG), Grinta = grit built across the four Phases (EE, no basement C-labels — V), Momentum
// (renamed from Daily Beat), the recalibration framing (HH), and the redesigned Journey panel.
      ...
      <div className="card">
        ...
        <section>
          ...
          <ul className="fg-pieces">
            ...
            <li><strong>Your Reclaim List</strong> — the concrete things you’re coming back for — your goals, in your words, with simple logging. <em>How to use it:</em> add or refine items just by talking to your Companion. Log progress when you have it. These are what the work is aiming at.</li>
            ...
            <li><strong>Activity</strong> — everything you’re doing, in one place: connect the apps you already use so the work in Rebuild and Reclaim shows up automatically. <em>How to use it:</em> connect a source when it’s available, or tell your Companion about a walk or a workout and it lands here.</li>
        ...
        <section>
          ...
          <p>There’s no wrong way to do this, but if you want a default: do a Session when you’ve got the time, make your calls and mark them in Momentum, log your Reclaim items as life happens, drop into Community when you want company, and revisit your Playbook whenever you need to remember who you are. Small and steady wins this.</p>
        </section>
