      ...
      <div className="card">
        ...
        <section>
          ...
          <ul className="fg-pieces">
            ...
            <li><strong>Checkpoints</strong> — the moment at the end of each Phase where you look back and we measure what you built. This is where your Grinta updates. <em>How to use it:</em> treat it as a mile-marker. Answer as it truly feels — a slip you noticed and came back from still counts as building, and the number can dip as well as climb. A dip usually just means you’re seeing yourself more clearly than you could at the start.</li>
