  ...
  return (
    <SubpageShell memberId={memberId}>
      ...
      <div className="card sub-copy prog-lead">
        ...
        <p>Each building phase runs the same three moves. You take a read — a clear look at where you stand. You build a tool you keep — a true line, a picture, a plan. You practice it for a week, in real life. A read, a tool, a tracked week — the same three, every phase.</p>
