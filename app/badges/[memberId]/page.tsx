...
const BADGE_MEANING: Record<string, string> = {
  'named-yourself': 'You identified the Doors you walked through, the life events that created the distance between who you are and who you want to be.',
  ...
  return (
    <>
      ...
      <div className="card sub-copy">
        ...
        <p>You don’t get one for showing up or logging in. You get one for the moves that count — passing a stretch of grit, reclaiming something on your list, coming back after a miss, crossing a Checkpoint. They’re meant to be hard. The accumulation is the whole game: a passport that fills is a life being won back.</p>
