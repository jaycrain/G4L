  ...
  "beats": [
    {
      ...
      "content": "Before anything else, let's get a clear read on where you're starting. Twenty-four things, 1 to 5, how true each feels right now. Nothing to study for, no score to pass. A few will sting — that sting is the point.",
      "dose": "medium",
      "rhythm": "once",
      "channel": "in_app",
      "readiness": [],
    ...
    },
    {
      ...
      "content": "Your ID Score is set — one number for how far the gap runs today, built from four parts: body, self, the people around you, and where you're headed. This is your slow, true metric. It moves every 60 days, not every day, on purpose.",
      "dose": "light",
      "rhythm": "once",
      "channel": "in_app",
      "readiness": [
    ...
    },
    {
      ...
      "content": "It's been 60 days. Same twenty-four, same questions. Let's see what's moved. Remember: this one's allowed to be still — real change in who you are doesn't jump week to week.",
      "dose": "medium",
      "rhythm": "once",
      "channel": "in_app",
      "readiness": [
    ...
    },
    {
      ...
      "content": "Something usually opens the gap — and rarely all at once. For most people it traces back to a door: a life event, or a slow stretch, where the drift quietly began. Tell me in your own words — what changed, and when did you first feel it?",
      "dose": "medium",
      "rhythm": "once",
      "channel": "in_app",
      "readiness": [],
    ...
    },
    {
      ...
      "content": "A baseline for your vehicle: how long can you go right now before it gets hard? No target yet, no judgment. We build from where you actually are — that's the only place a foundation holds.",
      "dose": "medium",
      "rhythm": "once",
      "channel": "in_app",
      "readiness": [
