...
export const BEATS_DATA = {
  ...
  "beats": [
    ...
    },
    {
      ...
      "content": "Something usually opens the gap — and rarely all at once. For most people it traces back to a door: a life event, or a slow stretch, where the Fade quietly began. Tell me in your own words — what changed, and when did you first feel it?",
      "dose": "medium",
      "rhythm": "once",
      "channel": "in_app",
      "readiness": [],
