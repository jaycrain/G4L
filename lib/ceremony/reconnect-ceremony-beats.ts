...
export const RECONNECT_CEREMONY_COPY = {
  ...
  grintaDown:
    "You just did the work in Reconnect — the kind of excavation most people never do. Your Grinta reads a little lower than your starting line, and that's not a step back: it means you're seeing yourself more clearly now. That clarity is the foundation everything builds on.",
  grintaFlat:
