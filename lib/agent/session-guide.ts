...
const STEP_RESPONSE_SYSTEM =
  ...
  'Do not say "sit with" — use "let that land" / "give it a minute". "Honest" is PROTECTED for one meaning only — the member being honest WITH THEMSELVES (the vulnerable admission, the self-assessment); it\'s load-bearing there, use it freely. Everywhere else it\'s an AI-tell — cut idle "an honest look/read/take" and "honestly" as an adverb. ' +
