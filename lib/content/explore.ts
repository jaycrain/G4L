  ...
  r1: {
    ...
    points: [
      ...
      { head: 'Rating areas separately beats one overall verdict',
        body: 'A single judgement about yourself tends to be blunt and hard to use. Research suggests a more differentiated picture — steady here, thin there — is both more accurate and easier to act on than a global sense of how you are doing.' },
  ...
  r2: {
    ...
    points: [
      { head: 'The circumstances that cause this are known, and common',
        body: 'Loss, a shrinking social world, a role that absorbs everything, caregiving, autopilot — research documents these as reliable disrupters of routine and self-concept, often long after the event. Naming yours places it in a recognised pattern rather than leaving it as private drift.' },
  ...
  r3: {
    ...
    points: [
      { head: 'Drift is patterned, not random',
        body: 'The Fade rarely arrives as one event. It shows up through repeated, individually reasonable choices that quietly move the baseline — and research suggests people steer better against a pattern they can see than against a general sense of slipping.' },
      { head: 'Aiming at a person works better than aiming at an outcome',
        body: 'A picture of who you want to become tends to organise effort more durably than a target you want to hit. It makes the work about becoming someone rather than completing tasks.' },
  ...
  w1: {
    ...
    points: [
      ...
      { head: '"It is too late" is the one that does the damage',
        body: 'Many of these lines carry a quiet claim that nothing you do matters. Replacing them tends to restore the sense that effort is worth spending, which is what people need to keep spending it.' },
  ...
  w2: {
    ...
    points: [
      ...
      { head: 'Aiming at a person, not an outcome',
        body: 'A future self acts like a guidepost: it organises attention and makes effort read as becoming someone rather than finishing a task. That tends to feel more personal and less mechanical.' },
  ...
  w3: {
    ...
    points: [
      ...
      { head: 'Catching drift while it is still small',
        body: 'Monitoring yourself is an active skill, not a passive one. Picking up the early signals and using them as a prompt to re-aim keeps a slip from quietly becoming the new pattern.' },
      { head: 'Contempt makes coming back harder',
        body: 'Harsh self-judgement tends to increase avoidance, which makes re-entry harder still. Meeting a lapse with honesty and perspective does not excuse it — it makes recovering from it more likely.' },
    ],
  },
  b1: {
    ...
    points: [
      ...
      { head: '"I have to" can become "this is mine"',
        body: 'Nobody needs to start out loving exercise or vegetables. What tends to matter is whether the behaviour can be connected to your own values and goals over time, which is a shift you can actually make.' },
  ...
  b3: {
    ...
    points: [
      { head: 'Watching a thing tends to change it',
        body: 'Self-monitoring is among the most reliable tools in behaviour change. Tracking something raises your awareness of it, and that awareness alone often shifts what you choose next.' },
      ...
      { head: 'A plan that survives a normal week, not your best one',
        body: 'People follow through more when a behaviour is specific — what, when, where, and what you will do if conditions are imperfect. Naming the smaller backup version in advance is what keeps an ordinary week from ending it.' },
      ...
      { head: 'Food and movement pull on each other',
        body: 'Health behaviours cluster: energy, sleep, mood and routine are not separate systems. Watching both at once tends to show you how they actually interact rather than how you assume they do.' },
  ...
  c2: {
    ...
    points: [
      ...
      { head: 'Moving toward, not only away',
        body: 'A life organised mostly around reducing threat tends to get smaller over time. Avoidance is not always wrong, but a healthier direction usually includes moving toward something, not only away from pain.' },
      ...
      { head: 'Good stretches widen what you are willing to try',
        body: 'Research suggests positive states broaden attention and openness, which supports more exploratory behaviour, which builds resources over time. The point is not forced positivity but noticing when the range is widening.' },
  ...
  c3: {
    ...
    points: [
      { head: 'Watch the process, and the product follows',
        body: 'Tracking a behaviour does not itself produce fitness or wellness. It strengthens the daily patterns that produce them — which is why the day, not the outcome, is what gets tracked here.' },
      ...
      { head: 'Wellness is a pattern, not a mood',
        body: 'It is not the absence of illness or a good day emotionally. It tends to be a state built by recurring behaviour across the physical, mental and social parts of life — which makes it something you can influence.' },
