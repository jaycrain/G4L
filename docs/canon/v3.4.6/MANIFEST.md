...
| :-- | --: | :-- | :-- |
| `member-transcript.md` | 82,930 | `c47ebba62512eefd` | clean authored copy, reading order. **QUOTE FROM THIS.** |
| `CHANGES.md` | 3,519 | `72799ae9b657de07` | what the authored copy ADDED / REMOVED since the previous version. **START HERE.** |
| `sync-note.md` | 5,592 | `f474c03a43633a03` | the Marketing Alignment Brief — what changed in voice / naming / story / function. |
...
| `founder-emails.md` | 9,969 | `cc2d5ded5878fc37` | the Founder Agent's drafted messages. Samples are quotable; live drafts vary. Never auto-sent. |
| `member-facing-strings.txt` | 544,652 | `e2fab6e0608b2b70` | full raw dump, traceability backstop. **Do NOT quote** — contains system/model-instruction strings. |
