...
| :-- | --: | :-- | :-- |
| `member-transcript.md` | 94,278 | `0409412d45d314b7` | clean authored copy, reading order. **QUOTE FROM THIS.** |
| `CHANGES.md` | 2,483 | `5e5da979f39045c8` | what the authored copy ADDED / REMOVED since the previous version. **START HERE.** |
| `sync-note.md` | 6,649 | `7eae5a05a95e64a4` | the Marketing Alignment Brief — what changed in voice / naming / story / function. |
...
| `founder-emails.md` | 9,969 | `9040de150473d7fd` | the Founder Agent's drafted messages. Samples are quotable; live drafts vary. Never auto-sent. |
| `member-facing-strings.txt` | 596,084 | `30a653aa0cb80717` | full raw dump, traceability backstop. **Do NOT quote** — contains system/model-instruction strings. |
