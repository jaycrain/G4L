...
| :-- | --: | :-- | :-- |
| `member-transcript.md` | 80,959 | `1f7ff241f924698a` | clean authored copy, reading order. **QUOTE FROM THIS.** |
| `CHANGES.md` | 4,632 | `edce82fe56636be9` | what the authored copy ADDED / REMOVED since the previous version. **START HERE.** |
| `sync-note.md` | 11,292 | `3347a28388fe29ac` | the Marketing Alignment Brief — what changed in voice / naming / story / function. |
| `voice-rules.md` | 17,533 | `6e42076e320fba53` | the brand + voice doc governing the DYNAMIC (model-generated) Companion copy. Describe, don't quote. |
| `founder-emails.md` | 9,969 | `0746981b18bebf78` | the Founder Agent's drafted messages. Samples are quotable; live drafts vary. Never auto-sent. |
| `member-facing-strings.txt` | 529,959 | `1d11adeeaec171e8` | full raw dump, traceability backstop. **Do NOT quote** — contains system/model-instruction strings. |
